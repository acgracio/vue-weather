            ...
            >
                <div class="flex flex-col md:flex-row items-center">
                    <div>
                        ...
                        <div>
                            Feels like {{ currentTemperature.feelsLike }}ºC
                        </div>
                    </div>
                    <div class="md:mx-5">
            ...
            >
                ...
                >
                    ...
                    <div class="w-2/3 px-4 flex items-center">
                        <div>
                            <img
                                :src="forecastIcon(day.weather[0].icon)"
                                width="70px"
                            />
                        </div>
                        <div class="ml-3">
                            {{ day.weather[0].description | uppercase }}
                        </div>
                    </div>
...
export default {
    ...
    methods: {
        fetchData() {
            fetch(
                `/api/weather?lat=${this.location.lat}&long=${this.location.long}`
            )
